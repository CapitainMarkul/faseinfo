...
class SearchPersonCommand(val searchRequest: String) : RpcCommand<List<PersonSearch>> {
    ...
    private fun generateFiveStubModels() =
        listOf(
            PersonSearch(UUID.randomUUID(), "Семен", "Петров", "Мобильная разработка", "img1.png"),
            PersonSearch(UUID.randomUUID(), "Николай", "Порошенко", "СБИС Диск", "img2.png"),
            PersonSearch(UUID.randomUUID(), "Анна", "Ивлеева", "Тех. поддержка", "img3.png"),
            PersonSearch(UUID.randomUUID(), "Нина", "Семенова", "Юрист", "img4.png"),
            PersonSearch(UUID.randomUUID(), "Георгий", "Павлов", "СБИС Продажи", "img5.png")
        )
